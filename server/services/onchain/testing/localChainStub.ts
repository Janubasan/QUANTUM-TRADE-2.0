...
/**
 * Chave de teste determinística — NÃO É SEGREDO.
 *
 * É a conta #1 do mnemônico PÚBLICO do Hardhat/Anvil
 * ("test test test test test test test test test test test junk" — 11x "test"
 * + "junk", 12 palavras), publicada na documentação do Hardhat, do Foundry e do
 * ethers. Deriva o endereço 0x70997970C51812dc3A010C7d01b50e0d17dc79C8 e não tem
 * valor em rede nenhuma. Verificado por:
 *
 *   node -e "const {ethers}=require('ethers'); \
 *     console.log(ethers.HDNodeWallet.fromMnemonic( \
 *       ethers.Mnemonic.fromPhrase('test test test test test test test test test test test junk'), \
 *       \"m/44'/60'/0'/0/1\").address)"
 *   -> 0x70997970C51812dc3A010C7d01b50e0d17dc79C8
 *
 * Se você viu isto numa varredura de segredos: é esperado e inofensivo.
 * NUNCA coloque aqui uma chave real.
 */
